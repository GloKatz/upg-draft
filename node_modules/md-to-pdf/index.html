...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "md-to-pdf";
    var mkdocs_page_input_path = "node_modules\\md-to-pdf\\README.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="md-to-pdf">md-to-pdf</h1>
<p>CLI tool to convert <code>Markdown</code> file to <code>PDF</code> file.</p>
<h2 id="install">Install:</h2>
<p><code>npm install --global md-to-pdf</code></p>
<h2 id="usage">Usage:</h2>
<p><code>md-to-pdf</code>: Convert all your <code>.md</code> files in working directory to <code>.pdf</code> files.</p>
<p><code>md-to-pdf /path/to/file.md</code>: Convert your <code>/path/to/file.md</code> to <code>/path/to/file.md</code></p>
<p><code>md-to-pdf /path/to/file1.md /path/to/file2.pdf</code>: Convert your <code>/path/to/file1.md</code> to <code>/path/to/file2.pdf</code></p>
