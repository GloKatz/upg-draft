...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\hasha\\readme.md";
...
<p><a href="https://travis-ci.org/sindresorhus/hasha"><img alt="Build Status" src="https://travis-ci.org/sindresorhus/hasha.svg?branch=master" /></a></p>
...
<pre><code>$ npm install --save hasha
</code></pre>

<h2 id="usage">Usage</h2>
<pre><code class="js">var hasha = require('hasha');
...
<h2 id="api">API</h2>
<p>See the Node.js <a href="https://nodejs.org/api/crypto.html#crypto_crypto_createhash_algorithm"><code>crypto</code> docs</a> for more about hashing.</p>
<h3 id="hashainput-options">hasha(input, [options])</h3>
<p>Returns a hash.</p>
<h4 id="input">input</h4>
<p>Type: <code>buffer</code>, <code>string</code>, <code>array</code> of <code>string</code>|<code>buffer</code></p>
...
Default: <code>hex</code><br />
Values: <code>hex</code>, <code>base64</code>, <code>buffer</code>, <code>binary</code></p>
<p>Encoding of the returned hash.</p>
<h5 id="algorithm">algorithm</h5>
<p>Type: <code>string</code><br />
Default: <code>sha512</code><br />
Values: <code>md5</code>, <code>sha1</code>, <code>sha256</code>, <code>sha512</code>, etc <em>(<a href="https://nodejs.org/api/crypto.html#crypto_crypto_createhash_algorithm">platform dependent</a>)</em></p>
...
<h3 id="hashastreamoptions">hasha.stream([options])</h3>
<p>Returns a <a href="https://nodejs.org/api/crypto.html#crypto_class_hash">hash transform stream</a>.</p>
<h3 id="hashafromstreamstream-options">hasha.fromStream(stream, [options])</h3>
<p>Returns a promise that resolves to a hash.</p>
<h3 id="hashafromfilefilepath-options">hasha.fromFile(filepath, [options])</h3>
<p>Returns a promise that resolves to a hash.</p>
<h3 id="hashafromfilesyncfilepath-options">hasha.fromFileSync(filepath, [options])</h3>
<p>Returns a hash.</p>
