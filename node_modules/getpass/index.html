...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\getpass\\README.md";
...
<pre><code class="javascript">const mod_getpass = require('getpass');
</code></pre>

<h2 id="api">API</h2>
<h3 id="mod_getpassgetpassoptions-callback"><code>mod_getpass.getPass([options, ]callback)</code></h3>
...
<p>Parameters:</p>
<ul>
<li><code>options</code>, an Object, with properties:</li>
<li><code>prompt</code>, an optional String</li>
<li><code>callback</code>, a <code>Func(error, password)</code>, with arguments:</li>
