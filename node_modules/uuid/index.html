...
<head>
  ...
  <title>uuid [![Build Status](https://secure.travis-ci.org/kelektiv/node-uuid.svg?branch=master)](http://travis-ci.org/kelektiv/node-uuid) # - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "uuid [![Build Status](https://secure.travis-ci.org/kelektiv/node-uuid.svg?branch=master)](http://travis-ci.org/kelektiv/node-uuid) #";
    var mkdocs_page_input_path = "node_modules\\uuid\\README.md";
...
<body class="wy-body-for-nav" role="document">
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>uuid [![Build Status](https://secure.travis-ci.org/kelektiv/node-uuid.svg?branch=master)](http://travis-ci.org/kelektiv/node-uuid) #</li>
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="uuid">uuid <a href="http://travis-ci.org/kelektiv/node-uuid"><img alt="Build Status" src="https://secure.travis-ci.org/kelektiv/node-uuid.svg?branch=master" /></a></h1>
...
<pre><code class="javascript">const uuidv1 = require('uuid/v1');
uuidv1(); // -&gt; '6c84fb90-12c4-11e1-840d-7b25c5ee775a'
</code></pre>

<p>Version 4 (random):</p>
<pre><code class="javascript">const uuidv4 = require('uuid/v4');
uuidv4(); // -&gt; '110ec58a-a0f2-4ac4-8393-c866d813b8d1'
</code></pre>

<p>Version 5 (namespace):</p>
<pre><code class="javascript">const uuidv5 = require('uuid/v5');
...
<pre><code class="html">&lt;script src=&quot;http://wzrd.in/standalone/uuid%2Fv1@latest&quot;&gt;&lt;/script&gt;
&lt;script&gt;
uuidv1(); // -&gt; v1 UUID
&lt;/script&gt;
</code></pre>
...
<pre><code class="html">&lt;script src=&quot;http://wzrd.in/standalone/uuid%2Fv4@latest&quot;&gt;&lt;/script&gt;
&lt;script&gt;
uuidv4(); // -&gt; v4 UUID
&lt;/script&gt;
</code></pre>
...
<pre><code class="html">&lt;script src=&quot;http://wzrd.in/standalone/uuid%2Fv5@latest&quot;&gt;&lt;/script&gt;
&lt;script&gt;
...
<li>
<p><code>node</code> - (Array) Node id as Array of 6 bytes (per 4.1.6). Default: Randomly generated ID.  See note 1.</p>
</li>
...
<li>
<p><code>nsecs</code> - (Number between 0-9999) additional time, in 100-nanosecond units. Ignored if <code>msecs</code> is unspecified. Default: internal uuid counter is used, as per 4.2.1.2.</p>
</li>
<li>
...
<pre><code class="javascript">uuidv1({
...
<pre><code class="javascript">// Generate two ids in an array
...
<ul>
<li><code>options</code> - (Object) Optional uuid state to apply. Properties may include:</li>
...
<pre><code class="javascript">const buffer = new Array(32); // (or 'new Buffer' in node.js)
uuid.v4(null, buffer, 0);
uuid.v4(null, buffer, 16);
</code></pre>

<h3 id="version-5">Version 5</h3>
<pre><code class="javascript">const uuidv5 = require('uuid/v4');
...
<p>Returns <code>buffer</code>, if specified, otherwise the string form of the UUID</p>
<p>Example:</p>
<pre><code class="javascript">// Generate a unique  namespace (typically you would do this once, outside of
...
<h2 id="deprecated-browser-ready-api">Deprecated / Browser-ready API</h2>
<p>The API below is available for legacy purposes and is not expected to be available post-3.X</p>
<pre><code class="javascript">const uuid = require('uuid');
...
<h2 id="legacy-node-uuid-package">Legacy node-uuid package</h2>
