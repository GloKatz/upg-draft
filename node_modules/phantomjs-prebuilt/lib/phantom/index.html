...
<head>
  ...
  <title>[PhantomJS](http://phantomjs.org) - Scriptable Headless WebKit - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "[PhantomJS](http://phantomjs.org) - Scriptable Headless WebKit";
    var mkdocs_page_input_path = "node_modules\\phantomjs-prebuilt\\lib\\phantom\\README.md";
...
<body class="wy-body-for-nav" role="document">
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>[PhantomJS](http://phantomjs.org) - Scriptable Headless WebKit</li>
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="phantomjs-scriptable-headless-webkit"><a href="http://phantomjs.org">PhantomJS</a> - Scriptable Headless WebKit</h1>
<p>PhantomJS (<a href="http://phantomjs.org">phantomjs.org</a>) is a headless WebKit scriptable with JavaScript.  The latest <a href="http://phantomjs.org/release-2.0.html">stable release</a> is version 2.0.</p>
<p><strong>Note</strong>: Please <strong>do not</strong> create a GitHub pull request <strong>without</strong> reading the <a href="https://github.com/ariya/phantomjs/blob/master/CONTRIBUTING.md">Contribution Guide</a> first. Failure to do so may result in the rejection of the pull request.</p>
<h2 id="use-cases">Use Cases</h2>
<ul>
<li><strong>Headless web testing</strong>. Lightning-fast testing without the browser is now possible!</li>
<li><strong>Page automation</strong>. <a href="http://phantomjs.org/page-automation.html">Access and manipulate</a> web pages with the standard DOM API, or with usual libraries like jQuery.</li>
...
<ul>
<li>Explore the complete <a href="http://phantomjs.org/documentation/">documentation</a>.</li>
<li>Read tons of <a href="http://phantomjs.org/buzz.html">user articles</a> on using PhantomJS.</li>
<li>Join the <a href="http://groups.google.com/group/phantomjs">mailing-list</a> and discuss with other PhantomJS fans.</li>
</ul>
<p>PhantomJS is free software/open source, and is distributed under the <a href="http://opensource.org/licenses/BSD-3-Clause">BSD license</a>. It contains third-party code, see the included <code>third-party.txt</code> file for the license information on third-party code.</p>
<p>PhantomJS is created and maintained by <a href="http://ariya.ofilabs.com/about">Ariya Hidayat</a> (Twitter: <a href="http://twitter.com/ariyahidayat">@ariyahidayat</a>), with the help of <a href="https://github.com/ariya/phantomjs/contributors">many contributors</a>. Follow the official Twitter stream <a href="http://twitter.com/PhantomJS">@PhantomJS</a> to get the frequent development updates.</p>
