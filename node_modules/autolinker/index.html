...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "Autolinker.js";
    var mkdocs_page_input_path = "node_modules\\autolinker\\README.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="autolinkerjs">Autolinker.js</h1>
...
<li>Autolinks URLs, whether or not they start with the protocol (i.e. 'http://'). In other words, it will automatically link the 
  text "google.com", as well as "http://google.com".</li>
...
<pre><code class="html">&lt;script src=&quot;path/to/Autolinker.min.js&quot;&gt;&lt;/script&gt;
</code></pre>

<h4 id="using-with-the-bower-package-manager">Using with the <a href="http://bower.io">Bower</a> package manager:</h4>
<p>Command line:</p>
<pre><code class="shell">bower install Autolinker.js --save
</code></pre>

<h4 id="using-with-nodejs-via-npm">Using with <a href="http://nodejs.org">Node.js</a> via <a href="https://www.npmjs.org/">npm</a>:</h4>
<p>Command Line:</p>
<pre><code class="shell">npm install autolinker --save
</code></pre>

<p>JavaScript:</p>
<pre><code class="javascript">var Autolinker = require( 'autolinker' );
...
<pre><code class="javascript">var linkedText = Autolinker.link( textToAutolink[, options] );
</code></pre>

<p>Using as a class:</p>
<pre><code class="javascript">var autolinker = new Autolinker( [ options ] );
...
<pre><code class="javascript">var linkedText = Autolinker.link( &quot;Check out google.com&quot;, { className: &quot;myLink&quot; } );
...
<ul>
<li><a href="http://gregjacobs.github.io/Autolinker.js/docs/#!/api/Autolinker-cfg-newWindow">newWindow</a> : Boolean<br />
  <code>true</code> to have the links should open in a new window when clicked, <code>false</code> otherwise. Defaults to <code>true</code>.<br /><br /></li>
<li><a href="http://gregjacobs.github.io/Autolinker.js/docs/#!/api/Autolinker-cfg-stripPrefix">stripPrefix</a> : Boolean<br />
  <code>true</code> to have the 'http://' or 'https://' and/or the 'www.' stripped from the beginning of links, <code>false</code> otherwise. Defaults to <code>true</code>.<br /><br /></li>
<li><a href="http://gregjacobs.github.io/Autolinker.js/docs/#!/api/Autolinker-cfg-truncate">truncate</a> : Number<br />
  ...
  Example: a url like 'http://www.yahoo.com/some/long/path/to/a/file' truncated to 25 characters may look like this: 'yahoo.com/some/long/pat..'<br /><br /></li>
<li><a href="http://gregjacobs.github.io/Autolinker.js/docs/#!/api/Autolinker-cfg-className">className</a> : String<br />
  A CSS class name to add to the generated anchor tags. This class will be added to all links, as well as this class
  plus "url"/"email"/"twitter" suffixes for styling url/email/twitter links differently.</li>
</ul>
<p>For example, if this config is provided as "myLink", then:</p>
<p>1) URL links will have the CSS classes: "myLink myLink-url"<br />
  2) Email links will have the CSS classes: "myLink myLink-email", and<br />
  3) Twitter links will have the CSS classes: "myLink myLink-twitter"<br /></p>
<ul>
<li><a href="http://gregjacobs.github.io/Autolinker.js/docs/#!/api/Autolinker-cfg-urls">urls</a> : Boolean<br />
  <code>true</code> to have URLs auto-linked, <code>false</code> to skip auto-linking of URLs. Defaults to <code>true</code>.<br /></li>
<li><a href="http://gregjacobs.github.io/Autolinker.js/docs/#!/api/Autolinker-cfg-email">email</a> : Boolean<br />
  <code>true</code> to have email addresses auto-linked, <code>false</code> to skip auto-linking of email addresses. Defaults to <code>true</code>.<br /><br /></li>
<li><a href="http://gregjacobs.github.io/Autolinker.js/docs/#!/api/Autolinker-cfg-twitter">twitter</a> : Boolean<br />
  <code>true</code> to have Twitter handles auto-linked, <code>false</code> to skip auto-linking of Twitter handles. Defaults to <code>true</code>.<br /><br /></li>
<li><a href="http://gregjacobs.github.io/Autolinker.js/docs/#!/api/Autolinker-cfg-replaceFn">replaceFn</a> : Function<br />
  A function to use to programmatically make replacements of matches in the input string, one at a time. See the section 
  <a href="#custom-replacement-function">Custom Replacement Function</a> for more details.</li>
</ul>
...
<pre><code class="javascript">var linkedText = Autolinker.link( &quot;Check out google.com&quot;, { newWindow: false } );
...
<pre><code class="javascript">var linkedText = Autolinker.link( &quot;http://www.yahoo.com/some/long/path/to/a/file&quot;, { truncate: 25, newWindow: false } );
...
<pre><code class="javascript">var myTextEl = document.getElementById( 'text' );
...
<pre><code class="javascript">var autolinker = new Autolinker( { newWindow: false, truncate: 25 } );
...
<h2 id="custom-replacement-function">Custom Replacement Function</h2>
...
<pre><code class="javascript">var input = &quot;...&quot;;  // string with URLs, Email Addresses, and Twitter Handles
...
<h2 id="full-api-docs">Full API Docs</h2>
