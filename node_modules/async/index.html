...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "Async.js";
    var mkdocs_page_input_path = "node_modules\\async\\README.md";
...
<pre><code class="javascript">async.map(['file1','file2','file3'], fs.stat, function(err, results){
...
<pre><code class="js">async.eachSeries(hugeArray, function iterator(item, callback) {
  if (inCache(item)) {
...
<pre><code class="js">// Here is a simple object with an (unnecessarily roundabout) squaring method
...
<p>Usage:</p>
<pre><code class="html">&lt;script type=&quot;text/javascript&quot; src=&quot;async.js&quot;&gt;&lt;/script&gt;
...
* <code>&lt;name&gt;Series</code> - the same as <code>&lt;name&gt;</code> but runs only a single async operation at a time
* <code>&lt;name&gt;Limit</code> - the same as <code>&lt;name&gt;</code> but runs a maximum of <code>limit</code> async operations at a time</p>
...
<h2 id="collections_1">Collections</h2>
<p><a name="forEach" />
<a name="each" /></p>
<h3 id="eacharr-iterator-callback">each(arr, iterator, [callback])</h3>
...
<pre><code class="js">// assuming openFiles is an array of file names and saveFile is a function
...
<pre><code class="js">// assuming openFiles is an array of file names
...
<p><a name="forEachOf" />
<a name="eachOf" /></p>
<h3 id="foreachofobj-iterator-callback">forEachOf(obj, iterator, [callback])</h3>
...
<pre><code class="js">var obj = {dev: &quot;/dev.json&quot;, test: &quot;/test.json&quot;, prod: &quot;/prod.json&quot;};
var configs = {};
...
<hr />
<p><a name="map" /></p>
<h3 id="maparr-iterator-callback">map(arr, iterator, [callback])</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">async.map(['file1','file2','file3'], fs.stat, function(err, results){
    // results is now an array of stats for each file
});
</code></pre>
...
<p><a name="select" />
<a name="filter" /></p>
<h3 id="filterarr-iterator-callback">filter(arr, iterator, [callback])</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">async.filter(['file1','file2','file3'], fs.exists, function(results){
    // results now equals an array of the existing files
});
</code></pre>
...
<hr />
<p><a name="reject" /></p>
<h3 id="rejectarr-iterator-callback">reject(arr, iterator, [callback])</h3>
...
<hr />
<p><a name="reduce" /></p>
<h3 id="reducearr-memo-iterator-callback">reduce(arr, memo, iterator, [callback])</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">async.reduce([1,2,3], 0, function(memo, item, callback){
    // pointless async:
...
<h3 id="reducerightarr-memo-iterator-callback">reduceRight(arr, memo, iterator, [callback])</h3>
...
<hr />
<p><a name="detect" /></p>
<h3 id="detectarr-iterator-callback">detect(arr, iterator, [callback])</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">async.detect(['file1','file2','file3'], fs.exists, function(result){
...
<hr />
<p><a name="sortBy" /></p>
<h3 id="sortbyarr-iterator-callback">sortBy(arr, iterator, [callback])</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">async.sortBy(['file1','file2','file3'], function(file, callback){
...
<pre><code class="js">//ascending order
...
<hr />
<p><a name="some" /></p>
<h3 id="somearr-iterator-callback">some(arr, iterator, [callback])</h3>
...
<pre><code class="js">async.some(['file1','file2','file3'], fs.exists, function(result){
...
<hr />
<p><a name="every" /></p>
<h3 id="everyarr-iterator-callback">every(arr, iterator, [callback])</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">async.every(['file1','file2','file3'], fs.exists, function(result){
...
<hr />
<p><a name="concat" /></p>
<h3 id="concatarr-iterator-callback">concat(arr, iterator, [callback])</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">async.concat(['dir1','dir2','dir3'], fs.readdir, function(err, files){
...
<h2 id="control-flow_1">Control Flow</h2>
<p><a name="series" /></p>
<h3 id="seriestasks-callback">series(tasks, [callback])</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">async.series([
    function(callback){
        // do some stuff ...
        callback(null, 'one');
    },
...
<hr />
<p><a name="parallel" /></p>
<h3 id="paralleltasks-callback">parallel(tasks, [callback])</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">async.parallel([
    function(callback){
        setTimeout(function(){
            callback(null, 'one');
        }, 200);
...
<hr />
<p><a name="whilst" /></p>
<h3 id="whilsttest-fn-callback">whilst(test, fn, callback)</h3>
...
<hr />
<p><a name="doWhilst" /></p>
<h3 id="dowhilstfn-test-callback">doWhilst(fn, test, callback)</h3>
...
<hr />
<p><a name="until" /></p>
<h3 id="untiltest-fn-callback">until(test, fn, callback)</h3>
...
<hr />
<p><a name="doUntil" /></p>
<h3 id="dountilfn-test-callback">doUntil(fn, test, callback)</h3>
...
<hr />
<p><a name="during" /></p>
<h3 id="duringtest-fn-callback">during(test, fn, callback)</h3>
...
<hr />
<p><a name="doDuring" /></p>
<h3 id="doduringfn-test-callback">doDuring(fn, test, callback)</h3>
...
<hr />
<p><a name="forever" /></p>
<h3 id="foreverfn-errback">forever(fn, [errback])</h3>
...
<pre><code class="js">async.forever(
    function(next) {
...
<h3 id="waterfalltasks-callback">waterfall(tasks, [callback])</h3>
...
<hr />
<p><a name="compose" /></p>
<h3 id="composefn1-fn2">compose(fn1, fn2...)</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">function add1(n, callback) {
    setTimeout(function () {
        callback(null, n + 1);
    }, 10);
}
...
<hr />
<p><a name="seq" /></p>
<h3 id="seqfn1-fn2">seq(fn1, fn2...)</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">// Requires lodash (or underscore), express3 and dresende's orm2.
...
<h3 id="applyeachfns-args-callback">applyEach(fns, args..., callback)</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">async.applyEach([enableSearch, updateSchema], 'bucket', callback);
...
<hr />
<p><a name="queue" /></p>
<h3 id="queueworker-concurrency">queue(worker, [concurrency])</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">// create a queue object with concurrency 2
...
<h3 id="priorityqueueworker-concurrency">priorityQueue(worker, concurrency)</h3>
...
<hr />
<p><a name="cargo" /></p>
<h3 id="cargoworker-payload">cargo(worker, [payload])</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">// create a cargo object with payload 2
...
<hr />
<p><a name="auto" /></p>
<h3 id="autotasks-concurrency-callback">auto(tasks, [concurrency], [callback])</h3>
...
<pre><code class="js">fs.readFile('data.txt', 'utf-8', cb, {});
</code></pre>
...
<hr />
<p><a name="retry" /></p>
<h3 id="retryopts-times-5-interval-0-5-task-callback">retry([opts = {times: 5, interval: 0}| 5], task, [callback])</h3>
...
<p><strong>Arguments</strong></p>
<ul>
<li><code>opts</code> - Can be either an object with <code>times</code> and <code>interval</code> or a number.</li>
...
<pre><code class="js">// try calling apiMethod 3 times
async.retry(3, apiMethod, function(err, result) {
    // do something with the result
});
</code></pre>

<pre><code class="js">// try calling apiMethod 3 times, waiting 200 ms between each retry 
async.retry({times: 3, interval: 200}, apiMethod, function(err, result) {
    // do something with the result
});
</code></pre>

<pre><code class="js">// try calling apiMethod the default 5 times no delay between each retry 
...
<hr />
<p><a name="iterator" /></p>
<h3 id="iteratortasks">iterator(tasks)</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">var iterator = async.iterator([
    function(){ sys.p('one'); },
    function(){ sys.p('two'); },
...
<hr />
<p><a name="apply" /></p>
<h3 id="applyfunction-arguments">apply(function, arguments..)</h3>
...
continuation:</p>
<pre><code class="js">node&gt; var fn = async.apply(sys.puts, 'one');
node&gt; fn('two', 'three');
one
two
three
...
<hr />
<p><a name="nextTick" /></p>
<h3 id="nexttickcallback-setimmediatecallback">nextTick(callback), setImmediate(callback)</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">var call_order = [];
...
<p><a name="times" /></p>
<h3 id="timesn-iterator-callback">times(n, iterator, [callback])</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">// Pretend this is some complicated async factory
...
<h2 id="utils_1">Utils</h2>
<p><a name="memoize" /></p>
<h3 id="memoizefn-hasher">memoize(fn, [hasher])</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">var slow_fn = function (name, callback) {
    // do something
    callback(null, result);
};
...
<h3 id="unmemoizefn">unmemoize(fn)</h3>
...
<h3 id="ensureasyncfn">ensureAsync(fn)</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">function sometimesAsync(arg, callback) {
  if (cache[arg]) {
...
<hr />
<p><a name="constant"></p>
<h3 id="constantvalues">constant(values...)</h3>
...
<p><a name="asyncify">
<a name="wrapSync"></p>
<h3 id="asyncifyfunc">asyncify(func)</h3>
...
<pre><code class="js">var q = async.queue(async.asyncify(async function (file) {
...
<hr />
<p><a name="log" /></p>
<h3 id="logfunction-arguments">log(function, arguments)</h3>
...
<p><strong>Example</strong></p>
<pre><code class="js">var hello = function(name, callback){
    setTimeout(function(){
...
<pre><code class="js">node&gt; async.log(hello, 'world');
'hello world'
</code></pre>

<hr />
<p><a name="dir" /></p>
<h3 id="dirfunction-arguments">dir(function, arguments)</h3>
...
<pre><code class="js">node&gt; async.dir(hello, 'world');
{hello: 'world'}
</code></pre>
