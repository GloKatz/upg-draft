...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "v1.5.2";
    var mkdocs_page_input_path = "node_modules\\async\\CHANGELOG.md";
...
- Added <code>asyncify</code>/<code>wrapSync</code> for making sync functions work with callbacks. (#671, #806)
- Added <code>during</code> and <code>doDuring</code>, which are like <code>whilst</code> with an async truth test. (#800)
- <code>retry</code> now accepts an <code>interval</code> parameter to specify a delay between retries. (#793)
- <code>async</code> should work better in Web Workers due to better <code>root</code> detection (#804)
- Callbacks are now optional in <code>whilst</code>, <code>doWhilst</code>, <code>until</code>, and <code>doUntil</code> (#642)
- Various internal updates (#786, #801, #802, #803)
- Various doc fixes (#790, #794)</p>
<p>Bug Fixes:
- <code>cargo</code> now exposes the <code>payload</code> size, and <code>cargo.payload</code> can be changed on the fly after the <code>cargo</code> is created. (#740, #744, #783)</p>
