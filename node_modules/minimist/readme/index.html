...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "minimist";
    var mkdocs_page_input_path = "node_modules\\minimist\\readme.markdown";
...
<p><a href="http://ci.testling.com/substack/minimist"><img alt="browser support" src="https://ci.testling.com/substack/minimist.png" /></a></p>
<p><a href="http://travis-ci.org/substack/minimist"><img alt="build status" src="https://secure.travis-ci.org/substack/minimist.png" /></a></p>
...
<h2 id="var-argv-parseargsargs-opts">var argv = parseArgs(args, opts={})</h2>
