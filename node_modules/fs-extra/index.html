...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\fs-extra\\README.md";
...
<p><code>fs-extra</code> adds file system methods that aren't included in the native <code>fs</code> module. It is a drop in replacement for <code>fs</code>.</p>
<p><a href="https://www.npmjs.org/package/fs-extra"><img alt="npm Package" src="https://img.shields.io/npm/v/fs-extra.svg?style=flat-square" /></a>
<a href="http://travis-ci.org/jprichardson/node-fs-extra"><img alt="build status" src="https://api.travis-ci.org/jprichardson/node-fs-extra.svg" /></a>
<a href="https://ci.appveyor.com/project/jprichardson/node-fs-extra/branch/master"><img alt="windows Build status" src="https://img.shields.io/appveyor/ci/jprichardson/node-fs-extra/master.svg?label=windows%20build" /></a>
<a href="https://www.npmjs.org/package/fs-extra"><img alt="downloads per month" src="http://img.shields.io/npm/dm/fs-extra.svg" /></a>
<a href="https://coveralls.io/r/jprichardson/node-fs-extra"><img alt="Coverage Status" src="https://img.shields.io/coveralls/jprichardson/node-fs-extra.svg" /></a></p>
...
<pre><code class="js">var fs = require('fs') // this is no longer necessary
</code></pre>

<p>you can now do this:</p>
<pre><code class="js">var fs = require('fs-extra')
</code></pre>
...
<pre><code class="js">var fse = require('fs-extra')
</code></pre>
...
<p>Options:
- clobber (boolean): overwrite existing file or directory, default is <code>true</code>.
- dereference (boolean): dereference symlinks, default is <code>false</code>.
- preserveTimestamps (boolean): will set last modification and access times to the ones of the original source files, default is <code>false</code>.
- filter: Function to filter copied files. Return <code>true</code> to include, <code>false</code> to exclude. This can also be a RegExp, however this is deprecated (See <a href="https://github.com/jprichardson/node-fs-extra/issues/239">issue #239</a> for background). <em>Warning: <code>copySync</code> currently applies the filter only to files (see <a href="https://github.com/jprichardson/node-fs-extra/issues/180">#180</a>). This will be fixed in a future release.</em></p>
...
<h3 id="emptydirdir-callback">emptyDir(dir, [callback])</h3>
...
<h3 id="ensurefilefile-callback">ensureFile(file, callback)</h3>
...
<h3 id="ensuredirdir-callback">ensureDir(dir, callback)</h3>
...
<h3 id="ensurelinksrcpath-dstpath-callback">ensureLink(srcpath, dstpath, callback)</h3>
...
<h3 id="ensuresymlinksrcpath-dstpath-type-callback">ensureSymlink(srcpath, dstpath, [type], callback)</h3>
...
<h3 id="mkdirsdir-callback">mkdirs(dir, callback)</h3>
...
<h3 id="movesrc-dest-options-callback">move(src, dest, [options], callback)</h3>
...
<h3 id="outputfilefile-data-options-callback">outputFile(file, data, [options], callback)</h3>
...
<h3 id="outputjsonfile-data-options-callback">outputJson(file, data, [options], callback)</h3>
<p>Almost the same as <code>writeJson</code>, except that if the directory does not exist, it's created.
...
<h3 id="readjsonfile-options-callback">readJson(file, [options], callback)</h3>
...
<h3 id="removedir-callback">remove(dir, callback)</h3>
...
<h3 id="walk">walk()</h3>
<p><strong>walk(dir, [streamOptions])</strong></p>
...
<pre><code class="js">var items = [] // files, directories, symlinks, etc
...
recommend this resource as a good starting point: https://strongloop.com/strongblog/whats-new-io-js-beta-streams3/.</p>
...
<h3 id="walksyncdir">walkSync(dir)</h3>
<p>Lists all files inside a directory recursively</p>
<p>Examples:</p>
<pre><code class="js">var fs = require('fs-extra')
...
<h3 id="writejsonfile-object-options-callback">writeJson(file, object, [options], callback)</h3>
<p>Writes an object to a JSON file. <code>options</code> are the same that
...
<p>Use <a href="https://github.com/petkaantonov/bluebird">Bluebird</a>. See https://github.com/petkaantonov/bluebird/blob/master/API.md#promisification. <code>fs-extra</code> is
explicitly listed as supported.</p>
<pre><code class="js">var Promise = require('bluebird')
...
<p>If you like TypeScript, you can use <code>fs-extra</code> with it: https://github.com/borisyankov/DefinitelyTyped/tree/master/fs-extra</p>
...
<code>copy</code>, <code>remove</code>, or <code>mkdirs</code> should be built on top of it.</p>
...
Build Date UTC : 2020-02-24 17:17:03
-->
