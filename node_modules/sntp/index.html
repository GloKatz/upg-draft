...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\sntp\\README.md";
...
to the local time.</p>
<p><a href="http://travis-ci.org/hueniverse/sntp"><img alt="Build Status" src="https://secure.travis-ci.org/hueniverse/sntp.png" /></a></p>
<h1 id="usage">Usage</h1>
<pre><code class="javascript">var Sntp = require('sntp');
...
<pre><code class="javascript">// Request offset once
...
<pre><code class="javascript">var before = Sntp.now();                    // System time without offset
