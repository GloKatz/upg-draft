...
<head>
  ...
  <title>ES6-Promise (subset of [rsvp.js](https://github.com/tildeio/rsvp.js)) [![Build Status](https://travis-ci.org/stefanpenner/es6-promise.svg?branch=master)](https://travis-ci.org/stefanpenner/es6-promise) - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "ES6-Promise (subset of [rsvp.js](https://github.com/tildeio/rsvp.js)) [![Build Status](https://travis-ci.org/stefanpenner/es6-promise.svg?branch=master)](https://travis-ci.org/stefanpenner/es6-promise)";
    var mkdocs_page_input_path = "node_modules\\es6-promise\\README.md";
...
<body class="wy-body-for-nav" role="document">
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>ES6-Promise (subset of [rsvp.js](https://github.com/tildeio/rsvp.js)) [![Build Status](https://travis-ci.org/stefanpenner/es6-promise.svg?branch=master)](https://travis-ci.org/stefanpenner/es6-promise)</li>
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="es6-promise-subset-of-rsvpjs">ES6-Promise (subset of <a href="https://github.com/tildeio/rsvp.js">rsvp.js</a>) <a href="https://travis-ci.org/stefanpenner/es6-promise"><img alt="Build Status" src="https://travis-ci.org/stefanpenner/es6-promise.svg?branch=master" /></a></h1>
...
<p>To use:</p>
<pre><code class="js">var Promise = require('es6-promise').Promise;
</code></pre>

<h2 id="bower">Bower</h2>
<p>To install:</p>
<pre><code class="sh">bower install es6-promise --save
</code></pre>

<h2 id="usage-in-ie9">Usage in IE&lt;9</h2>
...
<pre><code class="js">promise['catch'](function(err) {
  // ...
});
</code></pre>

<p>Or use <code>.then</code> instead:</p>
<pre><code class="js">promise.then(undefined, function(err) {
  // ...
});
</code></pre>
...
<p>Alternatively</p>
<pre><code class="js">require('es6-promise/auto');
</code></pre>
