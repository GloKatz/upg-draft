...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\commonmark\\README.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="commonmarkjs">commonmark.js</h1>
<p><a href="https://travis-ci.org/jgm/commonmark.js"><img alt="Build Status" src="https://img.shields.io/travis/jgm/commonmark.js/master.svg?style=flat" /></a>
<a href="https://www.npmjs.org/package/commonmark"><img alt="NPM version" src="https://img.shields.io/npm/v/commonmark.svg?style=flat" /></a></p>
...
from
<a href="https://raw.githubusercontent.com/jgm/commonmark.js/master/dist/commonmark.js">https://raw.githubusercontent.com/jgm/commonmark.js/master/dist/commonmark.js</a>,
or <code>bower install commonmark</code>.</p>
<p>To run tests for the JavaScript library:</p>
<pre><code>npm install # if needed to fetch dependencies
make test
</code></pre>
<p>To run benchmarks against some other JavaScript converters:</p>
<pre><code>npm install benchmark showdown marked markdown-it
make bench
</code></pre>
<p>To start an interactive dingus that you can use to try out
the library:</p>
<pre><code>make dingus
</code></pre>
...
<pre><code class="js">var reader = new commonmark.Parser();
...
<pre><code class="js">var writer = new commonmark.HtmlRenderer({sourcepos: true});
</code></pre>
...
breaks in HTML:</p>
<pre><code class="js">var writer = new commonmark.HtmlRenderer;
writer.softbreak = &quot;&lt;br /&gt;&quot;;
</code></pre>

<p>To make them render as spaces:</p>
<pre><code class="js">writer.softbreak = &quot; &quot;;
</code></pre>

<p>To override <code>escape</code>, pass it a function with two parameters:
...
<pre><code class="js">var writer = new commonmark.XmlRenderer({sourcepos: true});
</code></pre>
...
<li><code>type</code> (read-only):  a String, one of
  <code>text</code>, <code>softbreak</code>, <code>linebreak</code>, <code>emph</code>, <code>strong</code>,
  <code>html_inline</code>, <code>link</code>, <code>image</code>, <code>code</code>, <code>document</code>, <code>paragraph</code>,
  <code>block_quote</code>, <code>item</code>, <code>list</code>, <code>heading</code>, <code>code_block</code>,
...
<li><code>onEnter</code>, <code>onExit</code>: Strings, used only for <code>custom_block</code> or
  <code>custom_inline</code>.</li>
</ul>
...
<li><code>appendChild(child)</code>:  Append a Node <code>child</code> to the end of the
  Node's children.</li>
<li><code>prependChild(child)</code>:  Prepend a Node <code>child</code> to the
  beginning of the Node's children.</li>
...
<pre><code class="js">var walker = parsed.walker();
var event, node;
...
<tr>
<th>Sample</th>
<th align="right">showdown</th>
<th align="right">commonmark</th>
<th align="right">marked</th>
<th align="right">markdown-it</th>
</tr>
</thead>
<tbody>
<tr>
...
<pre><code>npm install showdown marked markdown-it benchmark
make bench-detailed
</code></pre>
