...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "isStream";
    var mkdocs_page_input_path = "node_modules\\isstream\\README.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="isstream">isStream</h1>
<p><a href="http://travis-ci.org/rvagg/isstream"><img alt="Build Status" src="https://secure.travis-ci.org/rvagg/isstream.png" /></a></p>
<p><strong>Test if an object is a <code>Stream</code></strong></p>
<p><a href="https://nodei.co/npm/isstream/"><img alt="NPM" src="https://nodei.co/npm/isstream.svg" /></a></p>
...
<pre><code class="js">var isStream = require('isstream')
...
<pre><code class="js">var isReadable = require('isstream').isReadable
