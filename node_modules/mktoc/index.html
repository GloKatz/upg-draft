...
<head>
  ...
  <title>Contents Index - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "Contents Index";
    var mkdocs_page_input_path = "node_modules\\mktoc\\README.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="contents-index">Contents Index</h1>
<p><a href="https://travis-ci.org/mkdoc/mktoc"><img alt="Build Status" src="https://travis-ci.org/mkdoc/mktoc.svg?v=3" /></a>
<a href="https://npmjs.org/package/mktoc"><img alt="npm version" src="http://img.shields.io/npm/v/mktoc.svg?v=3" /></a>
<a href="https://coveralls.io/github/mkdoc/mktoc?branch=master"><img alt="Coverage Status" src="https://coveralls.io/repos/mkdoc/mktoc/badge.svg?branch=master&amp;service=github&amp;v=3" /></a></p>
<blockquote>
<p>Generate a table of contents index</p>
</blockquote>
<p>Creates a list representing the structure of a document as determined by the headings in the document.</p>
<p>To inject the created list into a location in the document place the marker <code>&lt;!-- @toc --&gt;</code> in the source document.</p>
<p>By default it creates anchor links (<code>#</code>) to named anchors on the same page but the link behaviour may be disabled or customized using a <code>destination</code> function, see the <a href="#api">api docs</a>.</p>
<h2 id="install">Install</h2>
<pre><code>npm i mktoc --save
</code></pre>

<p>For the command line interface install <a href="https://github.com/mkdoc/mkdoc">mkdoc</a> globally (<code>npm i -g mkdoc</code>).</p>
<hr />
<ul>
...
<p>Create the stream and write a <a href="http://commonmark.org">commonmark</a> document:</p>
<pre><code class="javascript">var toc = require('mktoc')
  , ast = require('mkast');
ast.src('# Heading\n\n## Sub Heading\n\n')
  .pipe(toc())
...
<pre><code class="shell">mkcat README.md | mktoc -s | mkout &gt; TOC.md
</code></pre>

<p>Inject the table of contents into a document containing the <code>&lt;!-- @toc --&gt;</code> marker:</p>
<pre><code class="shell">mkcat readme.md | mktoc | mkout &gt; README.md
</code></pre>

<p>Set an initial heading with the specified level:</p>
<pre><code class="shell">mkcat readme.md | mktoc --title 'Table of Contents' --level 2 | mkout &gt; README.md
</code></pre>

<p>Only include headings for levels 2-4:</p>
<pre><code class="shell">mkcat readme.md | mktoc -d 2 -m 4 | mkout &gt; README.md
</code></pre>

<p>Create an ordered list and set the delimiter:</p>
<pre><code class="shell">mkcat readme.md | mktoc -o -E '.' | mkout &gt; README.md
</code></pre>

<h2 id="help">Help</h2>
<pre><code>Usage: mktoc [options]
...
<h2 id="api">API</h2>
<h3 id="toc">toc</h3>
<pre><code class="javascript">toc([opts][, cb])
</code></pre>

<p>Generate a document containing a table of contents list.</p>
<p>See <a href="#toc-1">Toc</a> for more available options.</p>
<p>Returns an output stream.</p>
<ul>
<li><code>opts</code> Object processing options.</li>
<li><code>cb</code> Function callback function.</li>
</ul>
<h4 id="options">Options</h4>
<ul>
<li><code>input</code> Readable input stream.</li>
<li><code>output</code> Writable output stream.</li>
</ul>
<h3 id="toc_1">Toc</h3>
<pre><code class="javascript">new Toc([opts])
</code></pre>

<p>Create a table of contents index stream.</p>
<p>Note that in order to build a complete index all data must be read so this
implementation buffers incoming nodes and flushes them when the stream
is ended writing the index nodes where necessary.</p>
<p>When the first child of a heading is a link it is preserved and no
automatic link is created, otherwise when creating links inline markup
in the heading is discarded.</p>
<p>If the <code>standalone</code> option is given then the incoming data is discarded
and the document representing the index is flushed.</p>
<p>When a <code>destination</code> function is specified it is passed a string
literal of the heading text and should return a URL, the function is
invoked in the scope of this stream.</p>
<p>Typically <code>prefix</code> will be either a <code>/</code>, <code>#</code> or the empty string
depending upon whether you want absolute, anchor or relative links. The
default is to use <code>#</code> for anchor links on the same page.</p>
<p>If the <code>bullet</code> option is given it must be one of <code>-</code>, <code>+</code> or <code>*</code>.</p>
<p>If the <code>delimiter</code> option is given it must a period <code>.</code> or right
...
<ul>
<li><code>standalone</code> Boolean discard incoming data.</li>
<li><code>type</code> String=bullet list output type, <code>bullet</code> or <code>ordered</code>.</li>
<li><code>link</code> Boolean=true whether to create links in the output lists.</li>
<li><code>depth</code> Number=1 ignore headings below this level.</li>
<li><code>max</code> Number=6 ignore headings above this level.</li>
<li><code>destination</code> Function builds the link URLs.</li>
<li><code>prefix</code> String=# default link prefix.</li>
<li><code>base</code> String a base path for absolute links.</li>
<li><code>bullet</code> String=- character for bullet lists.</li>
<li><code>delimiter</code> String=) delimiter for ordered lists.</li>
</ul>
<h2 id="license">License</h2>
<p>MIT</p>
<hr />
<p>Created by <a href="https://github.com/mkdoc/mkdoc">mkdoc</a> on April 18, 2016</p>
...
Build Date UTC : 2020-02-24 17:17:06
-->
