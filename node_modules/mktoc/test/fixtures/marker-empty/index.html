...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "Marker empty";
    var mkdocs_page_input_path = "node_modules\\mktoc\\test\\fixtures\\marker-empty.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <p>This files injects a TOC but has no headings so creates an empty list.</p>
<!-- @toc -->
