...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\klaw\\README.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="nodejs-klaw">Node.js - klaw</h1>
<p>A Node.js file system walker extracted from <a href="https://github.com/jprichardson/node-fs-extra">fs-extra</a>.</p>
<p><a href="https://www.npmjs.org/package/klaw"><img alt="npm Package" src="https://img.shields.io/npm/v/klaw.svg?style=flat-square" /></a>
<a href="http://travis-ci.org/jprichardson/node-klaw"><img alt="build status" src="https://api.travis-ci.org/jprichardson/node-klaw.svg" /></a>
...
<pre><code>npm i --save klaw
</code></pre>
<h2 id="name">Name</h2>
<p><code>klaw</code> is <code>walk</code> backwards :p</p>
<h2 id="usage">Usage</h2>
<h3 id="klawdirectory-options">klaw(directory, [options])</h3>
...
<pre><code class="js">var klaw = require('klaw')
...
<h3 id="aggregation-filtering-executing-actions-through-streams">Aggregation / Filtering / Executing Actions (Through Streams)</h3>
...
<pre><code class="js">klaw('/some/dir')
...
<h3 id="searching-strategy">Searching Strategy</h3>
