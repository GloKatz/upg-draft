...
<head>
  ...
  <title>Form-Data [![NPM Module](https://img.shields.io/npm/v/form-data.svg)](https://www.npmjs.com/package/form-data) [![Join the chat at https://gitter.im/form-data/form-data](http://form-data.github.io/images/gitterbadge.svg)](https://gitter.im/form-data/form-data) - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "Form-Data [![NPM Module](https://img.shields.io/npm/v/form-data.svg)](https://www.npmjs.com/package/form-data) [![Join the chat at https://gitter.im/form-data/form-data](http://form-data.github.io/images/gitterbadge.svg)](https://gitter.im/form-data/form-data)";
    var mkdocs_page_input_path = "node_modules\\form-data\\README.md";
...
<body class="wy-body-for-nav" role="document">
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Form-Data [![NPM Module](https://img.shields.io/npm/v/form-data.svg)](https://www.npmjs.com/package/form-data) [![Join the chat at https://gitter.im/form-data/form-data](http://form-data.github.io/images/gitterbadge.svg)](https://gitter.im/form-data/form-data)</li>
...
<p><a href="https://travis-ci.org/form-data/form-data"><img alt="Linux Build" src="https://img.shields.io/travis/form-data/form-data/v2.1.4.svg?label=linux:0.12-6.x" /></a>
<a href="https://travis-ci.org/form-data/form-data"><img alt="MacOS Build" src="https://img.shields.io/travis/form-data/form-data/v2.1.4.svg?label=macos:0.12-6.x" /></a>
<a href="https://ci.appveyor.com/project/alexindigo/form-data"><img alt="Windows Build" src="https://img.shields.io/appveyor/ci/alexindigo/form-data/v2.1.4.svg?label=windows:0.12-6.x" /></a></p>
<p><a href="https://coveralls.io/github/form-data/form-data?branch=master"><img alt="Coverage Status" src="https://img.shields.io/coveralls/form-data/form-data/v2.1.4.svg?label=code+coverage" /></a>
<a href="https://david-dm.org/form-data/form-data"><img alt="Dependency Status" src="https://img.shields.io/david/form-data/form-data.svg" /></a>
<a href="https://www.bithound.io/github/form-data/form-data"><img alt="bitHound Overall Score" src="https://www.bithound.io/github/form-data/form-data/badges/score.svg" /></a></p>
...
<pre><code class="javascript">var FormData = require('form-data');
var fs = require('fs');
...
<pre><code class="javascript">form.submit('http://example.org/', function(err, res) {
...
<pre><code class="javascript">form.submit('example.org/upload', function(err, res) {
  console.log(res.statusCode);
});
</code></pre>

<p>To use custom headers and pre-known length in parts:</p>
<pre><code class="javascript">var CRLF = '\r\n';
var form = new FormData();
...
<pre><code class="javascript">someModule.stream(function(err, stdout, stderr) {
  if (err) throw err;
...
<pre><code class="javascript">var formData = {
  my_field: 'my_value',
