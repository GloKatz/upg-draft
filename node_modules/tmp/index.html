...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\tmp\\README.md";
...
<p><a href="http://travis-ci.org/raszi/node-tmp"><img alt="Build Status" src="https://secure.travis-ci.org/raszi/node-tmp.png?branch=master" /></a></p>
...
<pre><code class="bash">npm install tmp
</code></pre>

<h2 id="usage">Usage</h2>
<h3 id="asynchronous-file-creation">Asynchronous file creation</h3>
<p>Simple temporary file creation, the file will be closed and unlinked on process exit.</p>
<pre><code class="javascript">var tmp = require('tmp');
...
<h3 id="synchronous-file-creation">Synchronous file creation</h3>
...
<h3 id="asynchronous-directory-creation">Asynchronous directory creation</h3>
...
<h3 id="synchronous-directory-creation">Synchronous directory creation</h3>
<p>A synchronous version of the above.</p>
<pre><code class="javascript">var tmp = require('tmp');
...
<h3 id="asynchronous-filename-generation">Asynchronous filename generation</h3>
...
<h3 id="synchronous-filename-generation">Synchronous filename generation</h3>
<p>A synchronous version of the above.</p>
<pre><code class="javascript">var tmp = require('tmp');
...
<h3 id="asynchronous-file-creation_1">Asynchronous file creation</h3>
...
<h3 id="synchronous-file-creation_1">Synchronous file creation</h3>
<p>A synchronous version of the above.</p>
<pre><code class="javascript">var tmp = require('tmp');
...
<h3 id="asynchronous-directory-creation_1">Asynchronous directory creation</h3>
...
<h3 id="synchronous-directory-creation_1">Synchronous directory creation</h3>
...
<h3 id="mkstemps-like-asynchronously">mkstemps like, asynchronously</h3>
...
<h3 id="mkstemps-like-synchronously">mkstemps like, synchronously</h3>
...
<h3 id="asynchronous-filename-generation_1">Asynchronous filename generation</h3>
...
<h3 id="synchronous-filename-generation_1">Synchronous filename generation</h3>
...
<h2 id="graceful-cleanup">Graceful cleanup</h2>
...
<li><code>template</code>: <a href="http://www.kernel.org/doc/man-pages/online/pages/man3/mkstemp.3.html"><code>mkstemps</code></a> like filename template, no default</li>
