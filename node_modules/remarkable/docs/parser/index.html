...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "Parsing Rules";
    var mkdocs_page_input_path = "node_modules\\remarkable\\docs\\parser.md";
...
used by the <a href="../renderer/">Renderer</a> to produce actual HTML.</p>
<p>There are three kind of parsing rules in Remarkable:</p>
<ol>
<li><a href="../parsing_core/">Core rules</a></li>
<li><a href="../parsing_block/">Block rules</a></li>
<li><a href="../parsing_inline/">Inline rules</a></li>
</ol>
...
<p>Tokens generated by <a href="../parsing_block/">block parsing rules</a> will also include a <code>lines</code>
...
<a href="../renderer/">rendering rule</a>.</p>
<h3 id="content-text-token">Content (<code>text</code>) token</h3>
...
<a href="../parsing_inline/">inline parsing rules</a>.</p>
<p>A text token has a <code>content</code> property containing the text it represents.</p>
<h3 id="block-content-inline-tokens">Block content (<code>inline</code>) tokens</h3>
