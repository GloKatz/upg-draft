...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\remarkable\\docs\\plugins.md";
...
<p>Plugins are then expected to add <a href="../parser/">parsing</a> and <a href="../renderer/">rendering</a>
rules and carry on appropriate modifications on the remarkable instance.</p>
<p>It's as simple as that.</p>
<h2 id="extending-remarkable-and-the-markdown-syntax">Extending remarkable and the Markdown syntax</h2>
...
(<a href="../parsing_core/">core</a>, <a href="../parsing_block/">block</a> and <a href="../parsing_inline/">inline</a>).</p>
...
<code>md.inline.ruler.push("strike-through", strikeThroughInlineRule, { strokesCount:
2 });</code> where <code>strikeThroughInlineRule</code> is your <a href="../parser/">parsing rule</a> for
strike-through.</p>
