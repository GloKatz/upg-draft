...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "Inline rules";
    var mkdocs_page_input_path = "node_modules\\remarkable\\docs\\parsing_inline.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="inline-rules">Inline rules</h1>
<p>The inline rules are responsible for parsing inline Markdown syntax formatting
only part of a line of text and emitting the <a href="../parser/">tokens</a> required to
...
<h2 id="state-inline">State inline</h2>
...
<li><code>cacheSet(key, value)</code>: adds a new value to the cache key-value store. <code>key</code>
  MUST be a non-negative integer (<code>&gt;= 0</code>) and value MUST a positive integer (<code>&gt;
  0</code>)</li>
...
<h2 id="rule-parser-behaviour">Rule parser behaviour</h2>
...
<p>To completely parse a block, you will need to push new <a href="../parser/">tokens</a> by
calling <code>state.push(token)</code>.</p>
<p>Once you are sure the current position marks the beginning of the syntax you are
trying to parse, you should push an <a href="../parser/">open tag token</a> corresponding to
...
<p>The last token you will need to emit is the <a href="../parser/">end tag token</a> for your
inline section.</p>
