...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "Block rules";
    var mkdocs_page_input_path = "node_modules\\remarkable\\docs\\parsing_block.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="block-rules">Block rules</h1>
<p>The block rules are responsible for parsing Markdown syntax encompassing a full
or several full lines at once and emitting the <a href="../parser/">tokens</a> required to
...
<h2 id="state-block">State block</h2>
...
<p>To completely parse a block, you will need to emit additional <a href="../parser/">tokens</a>
in <code>state.tokens</code>.</p>
<p>Once you are sure the current line marks the beginning of one of "your" blocks,
you should push an <a href="../parser/">open tag token</a> corresponding to the begining of
...
<a href="../parser/"><code>inline</code> token</a> with the content of the block. You could use
...
<p>The last token you will need to emit is the <a href="../parser/">end tag token</a> of your
block.</p>
