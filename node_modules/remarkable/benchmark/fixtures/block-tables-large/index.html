...
<head>
  ...
  <title>Block tables large - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "Block tables large";
    var mkdocs_page_input_path = "node_modules\\remarkable\\benchmark\\fixtures\\block-tables-large.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <p>this file contains large amounts of contiguous space characters (0x20)
and is designed to ensure erroneous and/or malicious content does not
cause the parser to choke.</p>
<table>
<thead>
<tr>
<th>There are 20k spaces between A and B in the next row</th>
</tr>
</thead>
<tbody>
<tr>
