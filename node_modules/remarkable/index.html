...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "remarkable";
    var mkdocs_page_input_path = "node_modules\\remarkable\\README.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="remarkable">remarkable</h1>
<p><a href="https://travis-ci.org/jonschlinkert/remarkable"><img alt="Build Status" src="https://travis-ci.org/jonschlinkert/remarkable.svg?branch=master" /></a>
<a href="https://www.npmjs.org/package/remarkable"><img alt="NPM version" src="https://img.shields.io/npm/v/remarkable.svg" /></a>
<a href="https://coveralls.io/r/jonschlinkert/remarkable?branch=dev"><img alt="Coverage Status" src="https://img.shields.io/coveralls/jonschlinkert/remarkable.svg" /></a></p>
<blockquote>
...
<pre><code class="bash">npm install remarkable --save
</code></pre>

<p><strong>bower:</strong></p>
<pre><code class="bash">bower install remarkable --save
</code></pre>
...
<pre><code class="js">var Remarkable = require('remarkable');
...
<pre><code class="sh">cat myfile.md | remarkable
...
<ul>
<li><a href="docs/parser/">parser</a></li>
<li><a href="docs/parsing_block/">parsing_block</a></li>
<li><a href="docs/parsing_core/">parsing_core</a></li>
<li><a href="docs/parsing_inline/">parsing_inline</a></li>
<li><a href="docs/plugins/">plugins</a></li>
<li><a href="docs/renderer/">renderer</a></li>
</ul>
...
<pre><code class="js">// Actual default values
var md = new Remarkable({
...
<h3 id="manage-rules">Manage rules</h3>
<pre><code class="js">var md = new Remarkable();
...
<h3 id="typographer">Typographer</h3>
...
plugins.</p>
<h2 id="references-thanks">References / Thanks</h2>
...
<h2 id="development-modification">Development / Modification</h2>
...
<pre><code class="js">Remarkable.core
...
<pre><code class="bash">$ benchmark/benchmark.js spec
