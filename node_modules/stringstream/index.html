...
<head>
  ...
  <title>Decode streams into strings The Right Way(tm) - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "Decode streams into strings The Right Way(tm)";
    var mkdocs_page_input_path = "node_modules\\stringstream\\README.md";
...
<body class="wy-body-for-nav" role="document">
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Decode streams into strings The Right Way(tm)</li>
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="decode-streams-into-strings-the-right-waytm">Decode streams into strings The Right Way(tm)</h1>
...
<pre><code class="javascript">// Stream from utf8 to hex to base64... Why not, ay.
...
<pre><code class="javascript">var stream = fs.createReadStream('myFile').pipe(strs('base64'))
