...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\stream-lines\\README.md";
...
<ul>
<li><a href="#stream-lines">Stream Lines</a></li>
...
<h1 id="stream-lines">Stream Lines</h1>
<p><a href="https://travis-ci.org/tmpfs/stream-lines"><img src="https://travis-ci.org/tmpfs/stream-lines.svg" alt="Build Status"></a>
<a href="https://npmjs.org/package/stream-lines"><img src="http://img.shields.io/npm/v/stream-lines.svg" alt="npm version"></a>
<a href="https://coveralls.io/github/tmpfs/stream-lines?branch=master"><img src="https://coveralls.io/repos/tmpfs/stream-lines/badge.svg?branch=master&service=github&v=1" alt="Coverage Status"></a>.</p>
<p>Line transform stream, reads bytes writes arrays of lines.</p>
<p>Requires <a href="http://nodejs.org">node</a> and <a href="http://www.npmjs.org">npm</a>.</p>
<h2 id="install">Install</h2>
<pre><code>npm i stream-lines --save
</code></pre>
...
<h3 id="lint">Lint</h3>
<p>Run the source tree through <a href="http://jshint.com/">jshint</a> and <a href="http://jscs.info/">jscs</a>:</p>
...
<p>Everything is <a href="http://en.wikipedia.org/wiki/MIT_License">MIT</a>. Read the <a href="https://github.com/tmpfs/stream-lines/blob/master/LICENSE">license</a> if you feel inclined.</p>
<p>Generated by <a href="https://github.com/freeformsystems/mdp">mdp(1)</a>.</p>
