...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "fd-slicer";
    var mkdocs_page_input_path = "node_modules\\fd-slicer\\README.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="fd-slicer">fd-slicer</h1>
<p><a href="https://travis-ci.org/andrewrk/node-fd-slicer"><img alt="Build Status" src="https://travis-ci.org/andrewrk/node-fd-slicer.svg?branch=master" /></a>
<a href="https://coveralls.io/r/andrewrk/node-fd-slicer"><img alt="Coverage Status" src="https://img.shields.io/coveralls/andrewrk/node-fd-slicer.svg" /></a></p>
...
<pre><code class="js">var fdSlicer = require('fd-slicer');
var fs = require('fs');
...
<h3 id="fdslicercreatefromfdfd-options">fdSlicer.createFromFd(fd, [options])</h3>
<pre><code class="js">var fdSlicer = require('fd-slicer');
fs.open(&quot;file.txt&quot;, 'r', function(err, fd) {
  if (err) throw err;
  var slicer = fdSlicer.createFromFd(fd);
...
<h3 id="fdslicercreatefrombufferbuffer">fdSlicer.createFromBuffer(buffer)</h3>
<pre><code class="js">var fdSlicer = require('fd-slicer');
var slicer = fdSlicer.createFromBuffer(someBuffer);
// ...
</code></pre>
...
<h5 id="createreadstreamoptions">createReadStream(options)</h5>
...
<h5 id="createwritestreamoptions">createWriteStream(options)</h5>
<p>Available <code>options</code>:</p>
<ul>
...
<h5 id="readbuffer-offset-length-position-callback">read(buffer, offset, length, position, callback)</h5>
<p>Equivalent to <code>fs.read</code>, but with concurrency protection.
<code>callback</code> must be defined.</p>
<h5 id="writebuffer-offset-length-position-callback">write(buffer, offset, length, position, callback)</h5>
