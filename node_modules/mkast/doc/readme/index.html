...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\mkast\\doc\\readme.md";
...
<p>Transforms [commonmark][] nodes to and from JSON for piping between processes.</p>
...
<p>Serialize [commonmark][] nodes to line-delimited JSON:</p>
