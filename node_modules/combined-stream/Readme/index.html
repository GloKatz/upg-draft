...
<head>
  ...
  <title>combined-stream - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "combined-stream";
    var mkdocs_page_input_path = "node_modules\\combined-stream\\Readme.md";
...
<pre><code class="javascript">var CombinedStream = require('combined-stream');
var fs = require('fs');
