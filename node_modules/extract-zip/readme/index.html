...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "extract-zip";
    var mkdocs_page_input_path = "node_modules\\extract-zip\\readme.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="extract-zip">extract-zip</h1>
...
<p><a href="https://nodei.co/npm/extract-zip/"><img alt="NPM" src="https://nodei.co/npm/extract-zip.png?global=true" /></a>
<a href="https://github.com/feross/standard"><img alt="js-standard-style" src="https://cdn.rawgit.com/feross/standard/master/badge.svg" /></a>
<a href="https://travis-ci.org/maxogden/extract-zip"><img alt="Build Status" src="https://travis-ci.org/maxogden/extract-zip.svg?branch=master" /></a></p>
...
<pre><code class="js">var extract = require('extract-zip')
...
<li><code>onEntry</code> - function - if present, will be called with <code>(entry, zipfile)</code>, entry is every entry from the zip file forwarded from the <code>entry</code> event from yauzl. <code>zipfile</code> is the <code>yauzl</code> instance</li>
</ul>
<p>Default modes are only used if no permissions are set in the zip file.</p>
<h2 id="cli-usage">CLI Usage</h2>
<pre><code>extract-zip foo.zip &lt;targetDirectory&gt;
</code></pre>

<p>If not specified, <code>targetDirectory</code> will default to <code>process.cwd()</code>.</p>
