...
<head>
  ...
  <title>performance-now [![Build Status](https://travis-ci.org/meryn/performance-now.png?branch=master)](https://travis-ci.org/meryn/performance-now) [![Dependency Status](https://david-dm.org/meryn/performance-now.png)](https://david-dm.org/meryn/performance-now) - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "performance-now [![Build Status](https://travis-ci.org/meryn/performance-now.png?branch=master)](https://travis-ci.org/meryn/performance-now) [![Dependency Status](https://david-dm.org/meryn/performance-now.png)](https://david-dm.org/meryn/performance-now)";
    var mkdocs_page_input_path = "node_modules\\performance-now\\README.md";
...
<body class="wy-body-for-nav" role="document">
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>performance-now [![Build Status](https://travis-ci.org/meryn/performance-now.png?branch=master)](https://travis-ci.org/meryn/performance-now) [![Dependency Status](https://david-dm.org/meryn/performance-now.png)](https://david-dm.org/meryn/performance-now)</li>
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="performance-now">performance-now <a href="https://travis-ci.org/meryn/performance-now"><img alt="Build Status" src="https://travis-ci.org/meryn/performance-now.png?branch=master" /></a> <a href="https://david-dm.org/meryn/performance-now"><img alt="Dependency Status" src="https://david-dm.org/meryn/performance-now.png" /></a></h1>
...
<pre><code class="javascript">var now = require(&quot;performance-now&quot;)
var start = now()
var end = now()
