...
<head>
  ...
  <title>assert-plus Changelog - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "assert-plus Changelog";
    var mkdocs_page_input_path = "node_modules\\assert-plus\\CHANGES.md";
