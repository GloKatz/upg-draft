...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "yauzl";
    var mkdocs_page_input_path = "node_modules\\yauzl\\README.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="yauzl">yauzl</h1>
<p><a href="https://travis-ci.org/thejoshwolfe/yauzl"><img alt="Build Status" src="https://travis-ci.org/thejoshwolfe/yauzl.svg?branch=master" /></a>
<a href="https://coveralls.io/r/thejoshwolfe/yauzl"><img alt="Coverage Status" src="https://img.shields.io/coveralls/thejoshwolfe/yauzl.svg" /></a></p>
...
<pre><code class="js">var yauzl = require(&quot;yauzl&quot;);
var fs = require(&quot;fs&quot;);
...
<pre><code class="js">function defaultCallback(err) {
  if (err) throw err;
}
</code></pre>

<h3 id="openpath-options-callback">open(path, [options], [callback])</h3>
<p>Calls <code>fs.open(path, "r")</code> and gives the <code>fd</code>, <code>options</code>, and <code>callback</code> to <code>fromFd()</code> below.</p>
...
<pre><code class="js">zipfile.once(&quot;end&quot;, function() {
  zipfile.close();
});
</code></pre>
...
<h3 id="fromfdfd-options-callback">fromFd(fd, [options], [callback])</h3>
...
<h3 id="frombufferbuffer-options-callback">fromBuffer(buffer, [options], [callback])</h3>
...
<h3 id="fromrandomaccessreaderreader-totalsize-options-callback">fromRandomAccessReader(reader, totalSize, [options], [callback])</h3>
<p>This method of creating a zip file allows clients to implement their own back-end file system.
...
See <code>open()</code> for the meaning of the options.</p>
<h3 id="dosdatetimetodatedate-time">dosDateTimeToDate(date, time)</h3>
...
<h3 id="class-zipfile">Class: ZipFile</h3>
...
<h4 id="event-entry">Event: "entry"</h4>
...
<h4 id="openreadstreamentry-callback">openReadStream(entry, callback)</h4>
...
<h4 id="entrycount">entryCount</h4>
...
<h3 id="class-entry">Class: Entry</h3>
...
<h4 id="extrafields">extraFields</h4>
...
<p><code>String</code> decoded with the same charset as used for <code>fileName</code>.</p>
<h4 id="getlastmoddate">getLastModDate()</h4>
<p>Effectively implemented as:</p>
<pre><code class="js">return dosDateTimeToDate(this.lastModFileDate, this.lastModFileTime);
</code></pre>

<h3 id="class-randomaccessreader">Class: RandomAccessReader</h3>
...
<h4 id="randomaccessreader_readstreamforrangestart-end">randomAccessReader._readStreamForRange(start, end)</h4>
...
<h4 id="randomaccessreaderreadbuffer-offset-length-position-callback">randomAccessReader.read(buffer, offset, length, position, callback)</h4>
...
<h4 id="randomaccessreaderclosecallback">randomAccessReader.close(callback)</h4>
<p>Subclasses may implement this method.
...
<h2 id="how-to-avoid-crashing">How to Avoid Crashing</h2>
...
<h3 id="no-streaming-unzip-api">No Streaming Unzip API</h3>
...
<h3 id="limitted-zip64-support">Limitted ZIP64 Support</h3>
...
<h3 id="zip64-extensible-data-sector-is-ignored">ZIP64 Extensible Data Sector Is Ignored</h3>
...
<h3 id="no-multi-disk-archive-support">No Multi-Disk Archive Support</h3>
...
<h3 id="no-encryption-support">No Encryption Support</h3>
<p>Currently, the presence of encryption is not even checked,
and encrypted zip files will cause undefined behavior.</p>
<h3 id="local-file-headers-are-ignored">Local File Headers Are Ignored</h3>
...
<h3 id="no-crc-32-checking">No CRC-32 Checking</h3>
...
<h3 id="versionneededtoextract-is-ignored">versionNeededToExtract Is Ignored</h3>
...
<h3 id="no-support-for-obscure-compression-methods">No Support For Obscure Compression Methods</h3>
...
<h3 id="data-descriptors-are-ignored">Data Descriptors Are Ignored</h3>
...
<h3 id="archive-extra-data-record-is-ignored">Archive Extra Data Record Is Ignored</h3>
...
<h3 id="no-language-encoding-flag-support">No Language Encoding Flag Support</h3>
