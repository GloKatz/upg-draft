...
<head>
  ...
  <title>request-progress - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "request-progress";
    var mkdocs_page_input_path = "node_modules\\request-progress\\README.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="request-progress">request-progress</h1>
<p><a href="https://npmjs.org/package/request-progress"><img alt="NPM version" src="http://img.shields.io/npm/v/request-progress.svg" /></a> <a href="https://npmjs.org/package/request-progress"><img alt="Downloads" src="http://img.shields.io/npm/dm/request-progress.svg" /></a> <a href="https://travis-ci.org/IndigoUnited/node-request-progress"><img alt="Build Status" src="http://img.shields.io/travis/IndigoUnited/node-request-progress.svg" /></a> <a href="https://coveralls.io/r/IndigoUnited/node-request-progress"><img alt="Coverage Status" src="https://img.shields.io/coveralls/IndigoUnited/node-request-progress.svg" /></a> <a href="https://david-dm.org/IndigoUnited/node-request-progress"><img alt="Dependency status" src="https://img.shields.io/david/IndigoUnited/node-request-progress.svg" /></a> <a href="https://david-dm.org/IndigoUnited/node-request-progress#info=devDependencies"><img alt="Dev Dependency status" src="https://img.shields.io/david/dev/IndigoUnited/node-request-progress.svg" /></a></p>
...
<p>The <code>state</code> object emitted in the <code>progress</code> event is reused to avoid creating a new object for each event. <br />
If you wish to peek the <code>state</code> object at any time, it is available in <code>request.progressState</code>.</p>
<h2 id="tests">Tests</h2>
<p><code>$ npm test</code> <br />
<code>$ npm test-cov</code> to get coverage report</p>
