...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\ajv\\README.md";
...
<a href="https://coveralls.io/github/epoberezkin/ajv?branch=master"><img alt="Coverage Status" src="https://coveralls.io/repos/epoberezkin/ajv/badge.svg?branch=master&amp;service=github" /></a>
<a href="https://gitter.im/ajv-validator/ajv"><img alt="Gitter" src="https://img.shields.io/gitter/room/ajv-validator/ajv.svg" /></a></p>
...
<ul>
<li>Ajv implements full <a href="http://json-schema.org/">JSON Schema draft 4</a> standard:</li>
...
<pre><code class="html">&lt;script src=&quot;ajv.min.js&quot;&gt;&lt;/script&gt;
</code></pre>
...
<pre><code class="javascript">var schema = {
  &quot;properties&quot;: {
    &quot;smaller&quot;: {
      &quot;type&quot;: &quot;number&quot;,
...
<pre><code class="javascript">require('ajv-merge-patch')(ajv);
</code></pre>
...
<pre><code class="javascript">ajv.addKeyword('range', { type: 'number', compile: function (sch, parentSchema) {
  var min = sch[0];
  var max = sch[1];
...
<p>Example:</p>
<pre><code class="javascript">var ajv = new Ajv({ loadSchema: loadSchema });
...
<pre><code class="javascript">var ajv = new Ajv({ /* async: 'es7', */ transpile: 'nodent' });
...
<pre><code class="javascript">var ajv = new Ajv({ /* async: 'es7', */ transpile: 'regenerator' });
var validate = ajv.compile(schema); // transpiled es7 async function
validate(data).then(successFunc).catch(errorFunc);
</code></pre>
...
<pre><code class="javascript">var ajv = new Ajv({ async: 'es7', transpile: transpileFunc });
var validate = ajv.compile(schema); // transpiled es7 async function
validate(data).then(successFunc).catch(errorFunc);
</code></pre>
...
<tr>
<th>mode</th>
<th align="center">transpile<br>speed*</th>
<th align="center">run-time<br>speed*</th>
<th align="center">bundle<br>size</th>
</tr>
</thead>
<tbody>
<tr>
...
<p>Example:</p>
<pre><code class="javascript">var ajv = new Ajv({ removeAdditional: true });
var schema = {
  &quot;additionalProperties&quot;: false,
  &quot;properties&quot;: {
    &quot;foo&quot;: { &quot;type&quot;: &quot;number&quot; },
...
<pre><code class="javascript">var ajv = new Ajv({ useDefaults: true });
var schema = {
  &quot;type&quot;: &quot;object&quot;,
  &quot;properties&quot;: {
    &quot;foo&quot;: { &quot;type&quot;: &quot;number&quot; },
...
<pre><code class="javascript">var ajv = new Ajv({ useDefaults: 'shared' });
...
<p>Example 1:</p>
<pre><code class="javascript">var ajv = new Ajv({ coerceTypes: true });
var schema = {
  &quot;type&quot;: &quot;object&quot;,
  &quot;properties&quot;: {
    &quot;foo&quot;: { &quot;type&quot;: &quot;number&quot; },
...
<pre><code class="javascript">var ajv = new Ajv({ coerceTypes: 'array' });
var schema = {
  &quot;properties&quot;: {
...
<h5 id="compileasyncobject-schema-function-callback">.compileAsync(Object schema, Function callback)</h5>
...
<h5 id="addschemaarrayobjectobject-schema-string-key">.addSchema(Array&lt;Object&gt;|Object schema [, String key])</h5>
...
<h5 id="addmetaschemaarrayobjectobject-schema-string-key">.addMetaSchema(Array&lt;Object&gt;|Object schema [, String key])</h5>
...
<h5 id="removeschemaobject-schemastring-keystring-refregexp-pattern">.removeSchema([Object schema|String key|String ref|RegExp pattern])</h5>
...
<h5 id="addformatstring-name-stringregexpfunctionobject-format"><a name="api-addformat"></a>.addFormat(String name, String|RegExp|Function|Object format)</h5>
...
<h5 id="addkeywordstring-keyword-object-definition"><a name="api-addkeyword"></a>.addKeyword(String keyword, Object definition)</h5>
...
<h5 id="removekeywordstring-keyword">.removeKeyword(String keyword)</h5>
...
<li><em>coerceTypes</em>: change data type of data to match <code>type</code> keyword. See the example in <a href="#coercing-data-types">Coercing data types</a> and <a href="https://github.com/epoberezkin/ajv/blob/master/COERCION.md">coercion rules</a>. Option values:</li>
...
<ul>
<li><em>async</em>: determines how Ajv compiles asynchronous schemas (see <a href="#asynchronous-validation">Asynchronous validation</a>) to functions. Option values:</li>
...
<li><em>transpile</em>: determines whether Ajv transpiles compiled asynchronous validation function. Option values:</li>
...
<li><code>patternGroups</code> (with v5 option) - properties:</li>
