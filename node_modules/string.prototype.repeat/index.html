...
<head>
  ...
  <title>ES6 `String.prototype.repeat` polyfill [![Build status](https://travis-ci.org/mathiasbynens/String.prototype.repeat.svg?branch=master)](https://travis-ci.org/mathiasbynens/String.prototype.repeat) - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "ES6 `String.prototype.repeat` polyfill [![Build status](https://travis-ci.org/mathiasbynens/String.prototype.repeat.svg?branch=master)](https://travis-ci.org/mathiasbynens/String.prototype.repeat)";
    var mkdocs_page_input_path = "node_modules\\string.prototype.repeat\\README.md";
...
<body class="wy-body-for-nav" role="document">
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>ES6 `String.prototype.repeat` polyfill [![Build status](https://travis-ci.org/mathiasbynens/String.prototype.repeat.svg?branch=master)](https://travis-ci.org/mathiasbynens/String.prototype.repeat)</li>
...
<p>A robust &amp; optimized ES3-compatible polyfill for <a href="http://people.mozilla.org/~jorendorff/es6-draft.html#sec-string.prototype.repeat">the <code>String.prototype.repeat</code> method in ECMAScript 6</a>.</p>
...
<p>In a browser:</p>
<pre><code class="html">&lt;script src=&quot;repeat.js&quot;&gt;&lt;/script&gt;
</code></pre>

<p>Via <a href="http://npmjs.org/">npm</a>:</p>
<pre><code class="bash">npm install string.prototype.repeat
</code></pre>

<p>Then, in <a href="http://nodejs.org/">Node.js</a>:</p>
<pre><code class="js">require('string.prototype.repeat');
...
<p>This polyfill is available under the <a href="http://mths.be/mit">MIT</a> license.</p>
