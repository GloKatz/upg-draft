...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\markdown-pdf\\README.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="markdown-pdf">markdown-pdf <a href="https://travis-ci.org/alanshaw/markdown-pdf"><img alt="Build Status" src="https://travis-ci.org/alanshaw/markdown-pdf.svg" /></a> <a href="https://david-dm.org/alanshaw/markdown-pdf"><img alt="Dependency Status" src="https://david-dm.org/alanshaw/markdown-pdf.svg" /></a> <a href="https://coveralls.io/r/alanshaw/markdown-pdf?branch=master"><img alt="Coverage Status" src="https://img.shields.io/coveralls/alanshaw/markdown-pdf.svg?style=flat" /></a></h1>
...
<pre><code>npm install markdown-pdf
</code></pre>
<h2 id="example-usage">Example usage</h2>
<pre><code class="javascript">var markdownpdf = require(&quot;markdown-pdf&quot;)
  , fs = require(&quot;fs&quot;)
...
<p>Pass an options object (<code>markdownpdf({/* options */})</code>) to configure the output.</p>
<h4 id="optionscwd">options.cwd</h4>
<p>Type: <code>String</code><br />
Default value: <code>process.cwd()</code></p>
<p>Current working directory.</p>
<h4 id="optionsphantompath">options.phantomPath</h4>
<p>Type: <code>String</code><br />
Default value: Path provided by phantomjs module</p>
<p>Path to the phantomjs binary.</p>
<h4 id="optionscsspath">options.cssPath</h4>
<p>Type: <code>String</code><br />
Default value: <code>[module path]/markdown-pdf/css/pdf.css</code></p>
<p>Path to custom CSS file, relative to the current directory.</p>
<h4 id="optionshighlightcsspath">options.highlightCssPath</h4>
<p>Type: <code>String</code><br />
Default value: <code>[module path]/markdown-pdf/css/highlight.css</code></p>
<p>Path to custom highlight CSS file (for code highlighting with <a href="https://highlightjs.org">highlight.js</a>), relative to the current directory.</p>
<h4 id="optionspaperformat">options.paperFormat</h4>
<p>Type: <code>String</code><br />
Default value: <code>A4</code></p>
<p>'A3', 'A4', 'A5', 'Legal', 'Letter' or 'Tabloid'.</p>
<h4 id="optionspaperorientation">options.paperOrientation</h4>
<p>Type: <code>String</code><br />
Default value: <code>portrait</code></p>
<p>'portrait' or 'landscape'.</p>
<h4 id="optionspaperborder">options.paperBorder</h4>
<p>Type: <code>String</code><br />
Default value: <code>2cm</code></p>
<p>Supported dimension units are: 'mm', 'cm', 'in', 'px'</p>
<h4 id="optionsrunningspath">options.runningsPath</h4>
<p>Type: <code>String</code><br />
Default value: <code>runnings.js</code></p>
<p>Path to CommonJS module which sets the page header and footer (see <a href="runnings.js">runnings.js</a>).</p>
<h4 id="optionsrenderdelay">options.renderDelay</h4>
<p>Type: <code>Number</code><br />
Default value: Time until <a href="http://phantomjs.org/api/webpage/handler/on-load-finished.html"><code>page.onLoadFinished</code></a> event fired</p>
<p>Delay (in ms) before the PDF is rendered.</p>
<h4 id="optionsloadtimeout">options.loadTimeout</h4>
<p>Type: <code>Number</code><br />
Default value: <code>10000</code></p>
<p>If <code>renderDelay</code> option isn't set, this is the timeout (in ms) before the page is rendered in case the <code>page.onLoadFinished</code> event doesn't fire.</p>
<h4 id="optionspreprocessmd">options.preProcessMd</h4>
<p>Type: <code>Function</code><br />
Default value: <code>function () { return through() }</code></p>
<p>A function that returns a <a href="https://npmjs.org/package/through2">through2 stream</a> that transforms the markdown before it is converted to HTML.</p>
<h4 id="optionspreprocesshtml">options.preProcessHtml</h4>
<p>Type: <code>Function</code><br />
Default value: <code>function () { return through() }</code></p>
<p>A function that returns a <a href="https://npmjs.org/package/through2">through2 stream</a> that transforms the HTML before it is converted to PDF.</p>
<h4 id="optionsremarkable">options.remarkable</h4>
<p>Type: <code>object</code><br />
Default value: <code>{ html: true, breaks: true }</code></p>
<p>A config object that is passed to <a href="https://www.npmjs.com/package/remarkable#options">remarkable</a>, the underlying markdown parser.</p>
<h5 id="optionsremarkablepreset">options.remarkable.preset</h5>
<p>Type: <code>String</code>
Default value: <code>default</code></p>
<p>Use remarkable <a href="https://www.npmjs.com/package/remarkable#presets">presets</a> as a convenience to quickly enable/disable active syntax rules and options for common use cases.</p>
<p>Supported values are <code>default</code>, <code>commonmark</code> and <code>full</code></p>
<h5 id="optionsremarkableplugins">options.remarkable.plugins</h5>
<p>Type: <code>Array</code> of remarkable-plugin <code>Function</code>s<br />
Default value: <code>[]</code></p>
<p>An array of Remarkable plugin functions, that extend the markdown parser functionality.</p>
<h5 id="optionsremarkablesyntax">options.remarkable.syntax</h5>
<p>Type: <code>Array</code> of optional remarkable syntax <code>Strings</code>s<br />
Default value: <code>[]</code></p>
<p>An array of <a href="https://github.com/jonschlinkert/remarkable#syntax-extensions">optional Remarkable syntax extensions</a>, disabled by default, that extend the markdown parser functionality.</p>
<h2 id="api">API</h2>
<h3 id="frompathpath-opts-frompath-opts">from.path(path, opts) / from(path, opts)</h3>
<p>Create a readable stream from <code>path</code> and pipe to markdown-pdf. <code>path</code> can be a single path or array of paths.</p>
<h3 id="fromstringstring">from.string(string)</h3>
<p>Create a readable stream from <code>string</code> and pipe to markdown-pdf. <code>string</code> can be a single string or array of strings.</p>
<h3 id="concatfrompathspaths-opts">concat.from.paths(paths, opts)</h3>
<p>Create and concatinate readable streams from <code>paths</code> and pipe to markdown-pdf.</p>
<h3 id="concatfromstringsstrings-opts">concat.from.strings(strings, opts)</h3>
<p>Create and concatinate readable streams from <code>strings</code> and pipe to markdown-pdf.</p>
<h3 id="topathpath-cb-topath-cb">to.path(path, cb) / to(path, cb)</h3>
<p>Create a writeable stream to <code>path</code> and pipe output from markdown-pdf to it. <code>path</code> can be a single path, or array of output paths if you specified an array of inputs. The callback function <code>cb</code> will be invoked when data has finished being written.</p>
<h3 id="tobufferopts-cb">to.buffer(opts, cb)</h3>
<p>Create a <a href="https://npmjs.org/package/concat-stream">concat-stream</a> and pipe output from markdown-pdf to it. The callback function <code>cb</code> will be invoked when the buffer has been created.</p>
<h3 id="tostringopts-cb">to.string(opts, cb)</h3>
<p>Create a <a href="https://npmjs.org/package/concat-stream">concat-stream</a> and pipe output from markdown-pdf to it. The callback function <code>cb</code> will be invoked when the string has been created.</p>
<h2 id="more-examples">More examples</h2>
<h3 id="from-string-to-path">From string to path</h3>
<pre><code class="javascript">var markdownpdf = require(&quot;markdown-pdf&quot;)
...
<h3 id="from-multiple-paths-to-multiple-paths">From multiple paths to multiple paths</h3>
<pre><code class="javascript">var markdownpdf = require(&quot;markdown-pdf&quot;)
...
<h3 id="concat-from-multiple-paths-to-single-path">Concat from multiple paths to single path</h3>
<pre><code class="javascript">var markdownpdf = require(&quot;markdown-pdf&quot;)
...
<h3 id="transform-markdown-before-conversion">Transform markdown before conversion</h3>
<pre><code class="javascript">var markdownpdf = require(&quot;markdown-pdf&quot;)
  , split = require(&quot;split&quot;)
...
<h3 id="remarkable-options-and-plugins">Remarkable options and plugins</h3>
<p>Example using <a href="https://www.npmjs.com/package/remarkable-classy">remarkable-classy</a> plugin:</p>
<pre><code class="javascript">var markdownpdf = require(&quot;markdown-pdf&quot;)
...
<p>To use markdown-pdf as a standalone program from the terminal run</p>
<pre><code class="sh">npm install -g markdown-pdf
</code></pre>
...
Build Date UTC : 2020-02-24 17:17:04
-->
