...
<head>
  ...
  <title>Contributing to HTML5 Boilerplate - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "Contributing to HTML5 Boilerplate";
    var mkdocs_page_input_path = "node_modules\\markdown-pdf\\html5bp\\CONTRIBUTING.md";
...
<body class="wy-body-for-nav" role="document">
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>Contributing to HTML5 Boilerplate</li>
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="contributing-to-html5-boilerplate">Contributing to HTML5 Boilerplate</h1>
<p>♥ <a href="http://html5boilerplate.com">HTML5 Boilerplate</a> and want to get involved?
Thanks! There are plenty of ways you can help!</p>
...
<p>The <a href="https://github.com/h5bp/html5-boilerplate/issues">issue tracker</a> is
the preferred channel for <a href="#bugs">bug reports</a>, <a href="#features">features requests</a>
...
<p>Please <strong>do not</strong> use the issue tracker for personal support requests (use
  <a href="http://stackoverflow.com/questions/tagged/html5boilerplate">Stack Overflow</a>
  or IRC).</p>
</li>
<li>
...
<li>
<p>Please <strong>do not</strong> open issues or pull requests regarding the code in
  <a href="https://github.com/h5bp/server-configs-apache"><code>.htaccess</code></a>,
  <a href="https://github.com/jquery/jquery/"><code>jQuery</code></a>,
  <a href="https://github.com/Modernizr/Modernizr"><code>Modernizr</code></a> or
  <a href="https://github.com/necolas/normalize.css"><code>Normalize.css</code></a> (open them in
...
<li>
<p><strong>Isolate the problem</strong> &mdash; ideally create a <a href="http://css-tricks.com/6263-reduced-test-cases/">reduced test
...
<p><code>bash
   ...
   git remote add upstream https://github.com/h5bp/html5-boilerplate.git</code></p>
<ol>
<li>If you cloned a while ago, get the latest changes from upstream:</li>
</ol>
<p><code>bash
   git checkout master
   git pull upstream master</code></p>
<ol>
...
<p><code>bash
   git pull [--rebase] upstream master</code></p>
<ol>
...
license your work under the the terms of the <a href="../LICENSE/">MIT License</a>.</p>
