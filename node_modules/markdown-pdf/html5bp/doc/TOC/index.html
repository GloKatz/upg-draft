...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "TOC";
    var mkdocs_page_input_path = "node_modules\\markdown-pdf\\html5bp\\doc\\TOC.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <p><a href="http://html5boilerplate.com">HTML5 Boilerplate homepage</a></p>
<h1 id="html5-boilerplate-documentation">HTML5 Boilerplate documentation:</h1>
<h2 id="getting-started">Getting started</h2>
<ul>
<li><a href="../usage/">Usage</a> — Overview of the project contents.</li>
<li><a href="../faq/">FAQ</a> — Frequently asked questions, along with their answers.</li>
</ul>
<h2 id="the-core-of-html5-boilerplate">The core of HTML5 Boilerplate</h2>
<ul>
<li><a href="../html/">HTML</a> — A guide to the default HTML.</li>
<li><a href="../css/">CSS</a> — A guide to the default CSS.</li>
<li><a href="../js/">JavaScript</a> — A guide to the default JavaScript.</li>
<li><a href="https://github.com/h5bp/server-configs-apache/tree/master/doc">.htaccess</a>
  — All about the Apache web server configs (also see our <a href="https://github.com/h5bp/server-configs/blob/master/README.md">alternative server
  configs</a>).</li>
<li><a href="../crossdomain/">crossdomain.xml</a> — An introduction to making use of
  crossdomain requests.</li>
<li><a href="../misc/">Everything else</a>.</li>
</ul>
<h2 id="development">Development</h2>
<ul>
<li><a href="../extend/">Extending and customizing HTML5 Boilerplate</a> — Going further with
  the boilerplate.</li>
</ul>
<h2 id="related-projects">Related projects</h2>
<p>HTML5 Boilerplate has several related projects to help improve the performance
of your site/app in various production environments.</p>
<ul>
<li><a href="https://github.com/h5bp/server-configs">Server configs</a> — Configs for
  different servers.</li>
<li><a href="https://github.com/h5bp/node-build-script">Node build script</a> — A
  feature-rich <a href="https://github.com/gruntjs/grunt">grunt</a> plugin.</li>
<li><a href="https://github.com/h5bp/ant-build-script">Ant build script</a> — The original
  HTML5 Boilerplate build script.</li>
</ul>
