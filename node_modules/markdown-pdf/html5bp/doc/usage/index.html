...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\markdown-pdf\\html5bp\\doc\\usage.md";
...
<p>Once you have cloned or downloaded HTML5 Boilerplate, creating a site or app
usually involves the following:</p>
<ol>
...
<li>(Optionally run a build script to automate the optimization of your site -
   e.g. <a href="https://github.com/h5bp/ant-build-script">ant build script</a> or <a href="https://github.com/h5bp/node-build-script">node
   build script</a>).</li>
...
initial CSS to help get you started from a solid foundation. <a href="../css/">About the
CSS</a>.</p>
<h3 id="doc">doc</h3>
...
get you started. <a href="../js/">About the JavaScript</a>.</p>
<h3 id="htaccess">.htaccess</h3>
<p>The default web server configs are for Apache. For more information, please
refer to the <a href="https://github.com/h5bp/server-configs-apache/tree/master/doc">Apache Server Configs
documentation</a>.</p>
...
<p>If you are using Google Analytics, make sure that you edit the corresponding
snippet at the bottom to include your analytics ID.</p>
<h3 id="humanstxt">humans.txt</h3>
...
<h3 id="crossdomainxml">crossdomain.xml</h3>
<p>A template for working with cross-domain requests. <a href="../crossdomain/">About
crossdomain.xml</a>.</p>
<h3 id="icons">Icons</h3>
<p>Replace the default <code>favicon.ico</code> and Apple Touch Icon with your own.</p>
<p>If you want to use different Apple Touch Icons for different resolutions please
refer to the <a href="../extend/#apple-touch-icons">according documentation</a>.</p>
<p>You might want to check out Hans' handy <a href="http://drublic.de/blog/html5-boilerplate-favicons-psd-template/">HTML5 Boilerplate Favicon and Apple
Touch Icon
PSD-Template</a>.</p>
