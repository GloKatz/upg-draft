...
<head>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "Crossdomain";
    var mkdocs_page_input_path = "node_modules\\markdown-pdf\\html5bp\\doc\\crossdomain.md";
...
<h1 id="crossdomainxml">crossdomain.xml</h1>
<p>A cross-domain policy file is an XML document that grants a web client—such as
...
grant permissions for socket-based connections.</p>
<p>For full details, check out Adobe's article about the <a href="http://www.adobe.com/devnet/articles/crossdomain_policy_file_spec.html">cross-domain policy file
specification</a>.</p>
