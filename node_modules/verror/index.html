...
<head>
  ...
  <title>verror: rich JavaScript errors - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "verror: rich JavaScript errors";
    var mkdocs_page_input_path = "node_modules\\verror\\README.md";
...
<body class="wy-body-for-nav" role="document">
  ...
  <ul class="wy-breadcrumbs">
    ...
    <li>verror: rich JavaScript errors</li>
...
<pre><code class="javascript">var err = new VError('missing file: &quot;%s&quot;', '/etc/passwd');
...
<pre><code class="javascript">console.error(err2.cause().message);
</code></pre>
...
kind of Error:</p>
<pre><code class="javascript">var err1 = new Error('No such file or directory');
...
<code>VError</code>.</p>
<h3 id="verrorcauseerr"><code>VError.cause(err)</code></h3>
...
<h3 id="verrorinfoerr"><code>VError.info(err)</code></h3>
...
<h3 id="verrorfullstackerr"><code>VError.fullStack(err)</code></h3>
...
<h3 id="verrorfindcausebynameerr-name"><code>VError.findCauseByName(err, name)</code></h3>
...
<h3 id="verrorhascausewithnameerr-name"><code>VError.hasCauseWithName(err, name)</code></h3>
...
<h3 id="verrorerrorfromlisterrors"><code>VError.errorFromList(errors)</code></h3>
...
<h3 id="verrorerrorforeacherr-func"><code>VError.errorForEach(err, func)</code></h3>
...
case:</p>
<pre><code class="javascript">var err1 = new VError('something bad happened');
/* ... */
var err2 = new VError({
...
example:</p>
<pre><code class="javascript">var err3 = new VError({
    'name': 'RequestError',
    'cause': err2,
    'info': {
        'errno': 'EBADREQUEST'
...
<pre><code class="javascript">new MultiError(error_list)
</code></pre>
...
were other errors.</p>
<p>For example:</p>
<pre><code class="javascript">err = new MultiError([
...
<p>See separate <a href="CONTRIBUTING/">contribution guidelines</a>.</p>
