...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\aws4\\README.md";
...
<pre><code class="javascript">// you can also pass AWS credentials in explicitly (otherwise taken from process.env)
