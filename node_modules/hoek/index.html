...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\hoek\\README.md";
...
<li><a href="#binary-encodingdecoding" title="Binary Encoding/Decoding">Binary Encoding/Decoding</a></li>
...
<li><a href="#escaping-characters" title="Escaping Characters">Escaping Characters</a></li>
...
<pre><code class="javascript">var Hoek = require('hoek');
...
<h3 id="clonewithshallowobj-keys">cloneWithShallow(obj, keys)</h3>
...
<h3 id="mergetarget-source-isnulloverride-ismergearrays">merge(target, source, isNullOverride, isMergeArrays)</h3>
...
<h3 id="applytodefaultsdefaults-options-isnulloverride">applyToDefaults(defaults, options, isNullOverride)</h3>
...
<h3 id="applytodefaultswithshallowdefaults-options-keys">applyToDefaultsWithShallow(defaults, options, keys)</h3>
<p>keys is an array of key names to shallow copy</p>
...
<h3 id="deepequalb-a-options">deepEqual(b, a, [options])</h3>
...
<pre><code class="javascript">Hoek.deepEqual({ a: [1, 2], b: 'string', c: { d: true } }, { a: [1, 2], b: 'string', c: { d: true } }); //results in true
Hoek.deepEqual(Object.create(null), {}, { prototype: false }); //results in true
Hoek.deepEqual(Object.create(null), {}); //results in false
</code></pre>

<h3 id="uniquearray-key">unique(array, key)</h3>
...
<h3 id="maptoobjectarray-key">mapToObject(array, key)</h3>
...
<h3 id="intersectarray1-array2">intersect(array1, array2)</h3>
...
<h3 id="containref-values-options">contain(ref, values, [options])</h3>
<p>Tests if the reference value contains the provided values where:
- <code>ref</code> - the reference string, array, or object.
...
- <code>options</code> - an optional object with the following optional settings:
    - <code>deep</code> - if <code>true</code>, performed a deep comparison of the values.
    - <code>once</code> - if <code>true</code>, allows only one occurrence of each value.
    - <code>only</code> - if <code>true</code>, does not allow values not explicitly listed.
    - <code>part</code> - if <code>true</code>, allows partial match of the values (at least one must always match).</p>
...
<h3 id="reachobj-chain-options">reach(obj, chain, [options])</h3>
...
<h3 id="reachtemplateobj-template-options">reachTemplate(obj, template, [options])</h3>
...
<h3 id="transformobj-transform-options">transform(obj, transform, [options])</h3>
...
<pre><code class="javascript">var source = {
    address: {
        one: '123 main street',
        two: 'PO Box 1234'
    },
...
<h3 id="shallowobj">shallow(obj)</h3>
<p>Performs a shallow copy by copying the references of all the top level children where:
- <code>obj</code> - the object to be copied.</p>
<pre><code class="javascript">var shallow = Hoek.shallow({ a: { b: 1 } });
</code></pre>

<h3 id="stringifyobj">stringify(obj)</h3>
...
<h1 id="binary-encodingdecoding">Binary Encoding/Decoding</h1>
<h3 id="base64urlencodevalue">base64urlEncode(value)</h3>
<p>Encodes value in Base64 or URL encoding</p>
<h3 id="base64urldecodevalue">base64urlDecode(value)</h3>
...
<h3 id="escapehtmlstring">escapeHtml(string)</h3>
<pre><code class="javascript">
var string = '&lt;html&gt; hey &lt;/html&gt;';
var escapedString = Hoek.escapeHtml(string); // returns &amp;lt;html&amp;gt; hey &amp;lt;/html&amp;gt;
</code></pre>

<h3 id="escapeheaderattributeattribute">escapeHeaderAttribute(attribute)</h3>
<p>Escape attribute value for use in HTTP header</p>
<pre><code class="javascript">
var a = Hoek.escapeHeaderAttribute('I said &quot;go w\\o me&quot;');  //returns I said \&quot;go w\\o me\&quot;
</code></pre>

<h3 id="escaperegexstring">escapeRegex(string)</h3>
...
<h3 id="assertcondition-message">assert(condition, message)</h3>
<pre><code class="javascript">
var a = 1, b = 2;
...
<h3 id="abortmessage">abort(message)</h3>
...
<h3 id="displaystackslice">displayStack(slice)</h3>
...
<h3 id="callstackslice">callStack(slice)</h3>
...
<h3 id="nexttickfn">nextTick(fn)</h3>
...
<h3 id="uniquefilenamepath-extension">uniqueFilename(path, extension)</h3>
...
<pre><code class="javascript">var result = Hoek.uniqueFilename('./test/modules', 'txt'); // results in &quot;full/path/test/modules/{random}.txt&quot;
</code></pre>

<h3 id="isabsolutepathpath-platform">isAbsolutePath(path, [platform])</h3>
...
<h3 id="isintegervalue">isInteger(value)</h3>
<p>Check <code>value</code> to see if it is an integer.  Returns true/false.</p>
<pre><code class="javascript">var result = Hoek.isInteger('23')
</code></pre>
...
Build Date UTC : 2020-02-24 20:57:21
-->
