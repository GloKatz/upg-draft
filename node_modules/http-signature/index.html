...
<head>
  ...
  <title>node-http-signature - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "node-http-signature";
    var mkdocs_page_input_path = "node_modules\\http-signature\\README.md";
  ...
  <hr/>
          ...
          <div role="main">
            <div class="section">
                ...
                <h1 id="node-http-signature">node-http-signature</h1>
<p>node-http-signature is a node.js library that has client and server components
for Joyent's <a href="http_signing/">HTTP Signature Scheme</a>.</p>
