...
<head>
  ...
  <script>
    ...
    var mkdocs_page_input_path = "node_modules\\through3\\README.md";
...
<li><a href="#through3">through3</a></li>
...
<p><a href="https://travis-ci.org/tmpfs/through3"><img src="https://travis-ci.org/tmpfs/through3.svg" alt="Build Status"></a>
<a href="https://npmjs.org/package/through3"><img src="http://img.shields.io/npm/v/through3.svg" alt="npm version"></a>
<a href="https://coveralls.io/github/tmpfs/through3?branch=master"><img src="https://coveralls.io/repos/tmpfs/through3/badge.svg?branch=master&service=github&v=1" alt="Coverage Status"></a>.</p>
<p>Stream extends library tracking latest stable <a href="http://nodejs.org">node</a> with no external dependencies.</p>
<p>Requires <a href="http://nodejs.org">node</a> (&gt;=0.11).</p>
<h2 id="install">Install</h2>
<pre><code>npm i through3 --save
</code></pre>

<h2 id="api">API</h2>
<h3 id="through3">through3</h3>
<p>Utilities for creating stream subclass functions.</p>
<h4 id="extend">extend</h4>
<pre><code class="javascript">extend(type, ctor[, opts])
</code></pre>

<p>Creates a stream subclass.</p>
<p>Returns a stream subclass.</p>
<ul>
<li><code>type</code> Function The super class.</li>
<li><code>ctor</code> Function Constructor for the subclass.</li>
<li><code>opts</code> Object Default constructor options.</li>
</ul>
<h4 id="transform">transform</h4>
<pre><code class="javascript">transform(fn[, flush][, opts])
</code></pre>

<p>Creates a transform stream subclass.</p>
<p>Returns transform stream subclass.</p>
<ul>
<li><code>fn</code> Function The transform function.</li>
<li><code>flush</code> Function A flush function.</li>
<li><code>opts</code> Object Default constructor options.</li>
</ul>
<h4 id="cork">cork</h4>
<pre><code class="javascript">cork()
</code></pre>

<p>Creates a pass through stream subclass that calls cork to buffer all
input and write on end.</p>
<p>Useful when you need all the data before operations can begin.</p>
<p>Returns stream class that buffers the input.</p>
<h4 id="passthrough">passthrough</h4>
<pre><code class="javascript">passthrough(opts)
</code></pre>

<p>Get a pass through stream class.</p>
<p>Returns a stream that passes through data.</p>
<ul>
<li><code>opts</code> Object Stream construct options.</li>
</ul>
<h2 id="developer">Developer</h2>
<h3 id="test">Test</h3>
<p>Tests are not included in the package, clone the repository:</p>
<pre><code>npm test
</code></pre>

<h3 id="cover">Cover</h3>
<p>To generate code coverage run:</p>
<pre><code>npm run cover
</code></pre>

<h3 id="documentation">Documentation</h3>
<p>To generate all documentation:</p>
<pre><code>npm run docs
</code></pre>

<h3 id="readme">Readme</h3>
<p>To build the readme file from the partial definitions (requires <a href="https://github.com/tmpfs/mdp">mdp</a>):</p>
<pre><code>npm run readme
</code></pre>

<h2 id="license">License</h2>
<p>Everything is <a href="http://en.wikipedia.org/wiki/MIT_License">MIT</a>. Read the <a href="https://github.com/tmpfs/through3/blob/master/LICENSE">license</a> if you feel inclined.</p>
