...
<head>
  ...
  <title>delayed-stream - DCP</title>
  ...
  <script>
    // Current page data
    var mkdocs_page_name = "delayed-stream";
    var mkdocs_page_input_path = "node_modules\\delayed-stream\\Readme.md";
...
<pre><code class="javascript">var DelayedStream = require('delayed-stream');
...
<pre><code class="javascript">var delayed = DelayedStream.create(req);
